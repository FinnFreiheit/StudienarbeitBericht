...
Die These, das Progressive Web Apps plattformunabhängig und vollumfänglich eingesetzt werden können, wird im verlauf dieser Arbeit untersucht. 
...
Hierfür wird eine Applikation entwickelt, die die Grundfunktionen einer PWA implementiert. Die Anwendung soll 
 \begin{itemize}
     ...
     \item offline verfügbar sein
     \item und Push-Benachrichtigungen ermöglichen 
 \end{itemize}

 Im Anschluss wird die Anwendung auf den in Tabelle \ref{plattformen} aufgeführten Plattformen ausgeführt und untersucht, ob alle beschriebenen Funktionen vorhanden sind. 
